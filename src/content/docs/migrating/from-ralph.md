...
[duckflux](https://duckflux.openvibes.tech) is a declarative, YAML-based workflow DSL. You describe **what** should happen and in what order. The runtime handles execution, retries, parallelism, error handling, and tracing.
...
2. **Write your workflow** as a `.flux.yaml` file using the patterns above.
...
*Check the [duckflux docs](https://duckflux.openvibes.tech) for the full DSL reference, or jump straight to the [spec](https://github.com/duckflux/spec/blob/main/SPEC.md).*
