...
<Aside type="tip">
This hybrid approach lets you migrate incrementally. Move one job at a time from GHA YAML to a `.duck.yaml` file. Keep the GHA workflow as a thin wrapper that triggers `quack run`.
</Aside>
