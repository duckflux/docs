...
<Aside>
  Step outputs inside a loop are **overwritten on each iteration** — they always reflect the most recent execution. If you need to preserve results across iterations, use `execution.context` as a scratchpad (see [Variables and Expressions](/workflows/variables-and-expressions/)).
</Aside>
