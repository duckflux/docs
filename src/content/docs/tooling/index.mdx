...
{
  "yaml.schemas": {
    "https://raw.githubusercontent.com/duckflux/spec/main/duckflux.schema.json": "*.duck.yaml"
  }
}
```
...
| v1.5 | CLI linter (`quack lint`) | Structural validation, cross-reference checks, CEL parse |
